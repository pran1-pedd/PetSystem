...
public class PetInput {
	public PetStore takeInput() {
		...
		return new PetStore(id,PetCategory,PetType,PetColor,PetAge,PetPrice,PetisVaccinated,PetFoodHabits);
	}
	public PetStore UpdateInput() {
		Scanner sc = new Scanner(System.in);
		System.out.println("Enter pet Price");
		double PetPrice = sc.nextDouble();
		System.out.println("Enter if pet is vaccinated or not");
		boolean PetisVaccinated = sc.nextBoolean();
		return new PetStore(2,"fake","fake","fake",2,PetPrice,PetisVaccinated,"fake");
	}
}
