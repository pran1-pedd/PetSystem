...
import com.amdocs.petsearch.model.PetStore;
...
public class DatabaseManager {
    ...
    public void addPetDetails(PetStore pet) throws SQLException {
    ...
    public void updatePetPriceAndVaccinationStatus(int petid, double price, boolean isVaccinated) throws SQLException, PetException {
    	...
    	try (Connection connection = DatabaseManager.getConnection()) {
    	try (PreparedStatement preparedStatement = connection.prepareStatement(sql)){
    		PetStore pet = new PetStore(petid, "fake", "fake", "fake", 2, price, isVaccinated, "fake");
...
//                    System.out.println("No pets found in category '" + petCategory + "'.");
    ...
    public List<PetStore> showAllPets() throws SQLException {
    	List<PetStore> pets = new ArrayList<>();
...
//                    System.out.println("Pet ID: " + id + ", Pet Category: " + PetCategory + ", Pet Type: " + PetType + ", Pet Color: " + PetColor + ", Age " + age+ ", Price " + price + ", Is Pet Vaccinated: " + PetisVaccinated + ", foodHabits: " + foodHabits);
                    ...
                    PetStore pet = new PetStore(id,PetCategory,PetType,PetColor,age,price,PetisVaccinated,foodHabits);
                    pets.add(pet);
                }
            }
...
//       System.out.print(pets.toString());
    ...
    public List<PetStore> searchByPrice(double min, double max) throws SQLException {
